...
// Function found here https://thispointer.com/javascript-check-if-string-is-url/
...
const fetcher = (url, dest) => {
  ...
  if (fs.existsSync(dest)) {
    ...
    Do you wish to overwrite? Y/N: `, answer => {

      if (answer === 'y' || answer === 'Y') {
        request(url, (error, response, body) => {
          if (error) console.log('URL request error:', error); // Print the error if one occurred
